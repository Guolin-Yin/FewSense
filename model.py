...
class models:
    ...
    # def buildFeatureExtractor( self, input = None):
    #     input = Input( config.input_shape, name = 'input_layer' )
    #     x = Conv2D(filters = 96, kernel_size = (11, 5), strides = 2, input_shape = config.input_shape,padding = 'valid',activation = 'relu', name = 'Conv_1')( input )
